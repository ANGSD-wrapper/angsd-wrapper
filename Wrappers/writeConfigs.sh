...
\n\
#   Saf file\n\
#       This another output file from the site frequency spectrum wrapper\n\
#       This should end in '_Diversity.saf.idx'\n\
SAF=\n\
#   Determines if calculated Theta estimates should assume an unfolded\n\
#   spectrum (0) or folded spectrum (1). Default is unfolded
FOLD=0\n\
#   Thetas Parameters\n\
#       Listed below are the defaults, please modify for your samples\n\
DO_SAF=2\n\
...
function configByProject() {
    ...
    #   Write the configuration file for Thetas
    createThetas "${commonPath}" "${project}_Example" "${configurationDirectory}"
